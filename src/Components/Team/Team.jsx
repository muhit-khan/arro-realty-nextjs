...
import img1 from '../../../public/images/user-1.png';
import img2 from '../../../public/images/user-2.png';
import img3 from '../../../public/images/user-3.png';
import img4 from '../../../public/images/user-4.png';
import img5 from '../../../public/images/user-1.png';
                ...
                <div className='relative w-full overflow-hidden'>
                    <div className='relative flex items-center justify-center h-96 mt-10 mb-20'>
                        <button
                            ...
                            className='p-2 bg-amber-500 bg-opacity-50 text-white rounded-full hover:bg-amber-600 active:bg-amber-500 z-20 absolute left-0'
                        >
                            <RiArrowLeftLine />
                        </button>
